# -*- coding: utf-8 -*-
"""
Created on Sat Feb 20 10:14:53 2021
...
class projectile:
    ...
    def __init__(self, angle, velocity, height):
        ...
        #20210226追加 进入磁场受力影响xy轴速度
        self.cxvel = 0.5 * velocity * sin(theta)
        self.cyvel = 0.5 * velocity * cos(theta)
    ...
    def update(self, time):
        ...
        #20210226追加 进入磁场半径覆盖范围
        if abs(self.xpos - 100) <= 30 and abs(self.ypos - 100) <= 30:      
            xvel1 = self.xvel - self.cxvel * time
            self.xpos = self.xpos + time * (self.xvel + xvel1) / 2.0
            self.xvel = xvel1
            yvel1 = self.yvel + self.cyvel * time
...
class Launcher:
    ...
    def __init__(self, win):
        ...
        #20210219追加坐标（100，100）,半径30的磁场        
        self.magnetic = Circle(Point(100,100), 30)
        self.magnetic.setFill("green")
        self.magnetic.setOutline("black")
        self.magnetic.draw(win)
